...
export default function AnswerEconomy() {
  return (
    <SectionLayout
      ...
      items={[
        { href: "/answer-economy/white-paper", tag: "WHITE PAPER", title: "The Answer Economy", desc: "The definitive guide to navigating the tectonic shift from search to synthesis and the rise of generative engine optimisation. 43 citations, 4,000 words." },
